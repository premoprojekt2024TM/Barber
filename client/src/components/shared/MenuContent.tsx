...
const secondaryListItems = [
  ...
  { text: "Ismerősök", icon: <ChatIcon />, path: "/search" },
];
...
export default function MenuContent() {
  ...
  useEffect(() => {
    ...
    const mainIndex = mainListItems.findIndex(
      ...
      <List dense>
        {mainListItems.map((item, index) => (
          <ListItem key={index} disablePadding sx={{ display: "block" }}>
            <ListItemButton
              selected={
                selectedItem.section === "main" && selectedItem.index === index
              }
      ...
      <List dense>
        {secondaryListItems.map((item, index) => (
          <ListItem key={index} disablePadding sx={{ display: "block" }}>
            <ListItemButton
              selected={
                selectedItem.section === "secondary" &&
