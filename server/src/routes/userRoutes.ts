...
import { deleteUser,  loginUser,  registerUser, updateUser } from '../controllers/authController';
...
export const userRoutes = async (fastify: FastifyInstance) => {
  ...
  fastify.get('/hair', { preHandler: [authenticateJwt, authorizeRole(['worker'])] }, async (request, reply) => {
