...
export const registerUser = async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  try {
    ...
    const newExtendedUser = new ExtendedUser();
    ...
    await AppDataSource.getRepository(ExtendedUser).save(newExtendedUser);
...
export const profile = async (request: AuthenticatedRequest, reply: FastifyReply) => {
  ...
  try {
    const userRepository = AppDataSource.getRepository(User);
    const extendedUserRepository = AppDataSource.getRepository(ExtendedUser);
